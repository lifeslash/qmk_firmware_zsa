...
enum tap_dance_codes {
    ...
    TD_6_QUOT,  // KC_6, KC_QUOT
    TD_T_DQUO,  // KC_T, KC_DQUO
    TD_G_EQL,   // KC_G, KC_EQL
    TD_7_BSLS,  // KC_7, KC_BSLS
    TD_Y_PIPE,  // KC_Y, KC_PIPE
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_6_QUOT] = ACTION_TAP_DANCE_DOUBLE(KC_6, KC_QUOT),
    [TD_T_DQUO] = ACTION_TAP_DANCE_DOUBLE(KC_T, KC_DQUO),
    [TD_G_EQL] =  ACTION_TAP_DANCE_DOUBLE(KC_G, KC_EQL),
    [TD_7_BSLS] = ACTION_TAP_DANCE_DOUBLE(KC_7, KC_BSLS),
    [TD_Y_PIPE] = ACTION_TAP_DANCE_DOUBLE(KC_Y, KC_PIPE),
